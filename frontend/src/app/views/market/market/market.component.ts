...
export class MarketComponent implements OnInit {
  ...
  imageObject: Array<object> = [{
    image: 'assets/images/market/1.jpg',
    thumbImage: 'assets/images/market/1.jpg'
  }, {
    image: 'assets/images/market/2.jpg',
    thumbImage: 'assets/images/market/2.jpg'
  }, {
    image: 'assets/images/market/3.jpg',
    thumbImage: 'assets/images/market/3.jpg'
  }];

  sliderWidth: String = '100%';
  sliderImageWidth: Number = 100;
  ...
  ngOnInit() {
    ...
    this.sliderImageWidth = document.getElementsByClassName('card-body')[0].clientWidth - 10;
  }
